...
for i in range(len(average_differences)):
    ...
    ax.set(xlabel='iteration', ylabel='tree similarity', title=f'Similarities between trees in layer {i+1}')

    ax.set_ylim(0,1)

    fig.savefig(f"C:/Users/David/PycharmProjects/Examensarbete/TranBackup/trees/Layer{i+1}.png")
    plt.show()
