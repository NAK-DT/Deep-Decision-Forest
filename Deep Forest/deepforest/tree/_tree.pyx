...
from numpy cimport PyArray_SetBaseObject, PyArrayObject
...
cdef extern from "numpy/arrayobject.h":
    object PyArray_NewFromDescr(PyTypeObject* subtype, object descr,
...
cdef class Tree:
    ...
    cdef np.ndarray _get_value_ndarray(self):
        ...
        Py_INCREF(self)
        #arr.base = self  # Safe in recent NumPy; remove if still causing issue
        return arr
