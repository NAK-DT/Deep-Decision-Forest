...
#df = pd.read_csv(r'C:\Users\David\PycharmProjects\Examensarbete\Datasets\breast-wisconsin.txt', header=None, sep="\s+")
#df = pd.read_csv(r'C:\Users\David\PycharmProjects\Examensarbete\Datasets\tic-tac-toe.data', header=None)#
#label_encoders = []
